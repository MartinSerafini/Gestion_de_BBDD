...
-- Creacion de la BBDD
-------------------------------------------------
CREATE DATABASE fabrica_electronica
    DEFAULT CHARACTER SET = 'utf8mb4';

use fabrica_electronica;
-------------------------------------------------
-- Diseño de la BBDD
-------------------------------------------------
...
CREATE TABLE IF NOT EXISTS OrdenCompra (
    ...
    fecha DATE NOT NULL,
    nro_orden INT(8) ZEROFILL NOT NULL,
...
-- ORDENES DE COMPRA 
-------------------------------------------------
INSERT INTO OrdenCompra (fecha, nro_orden, id_importador) VALUES
('2025-08-20', 00001234, 1),
('2025-08-21', 00001235, 2);
-------------------------------------------------
-- ORDENCOMPRA_DETALLE 
-------------------------------------------------
INSERT INTO OrdenCompra_Detalle (id_orden, id_pieza, cantidad) VALUES
(1, 1, 50), -- Placa Madre
(1, 2, 30), -- Pantalla
(1, 5, 20), -- Fuente
(2, 1, 40),
...
--------------------------------------------------
-- Consulta 3: Detalle de orden de compra (nro) con piezas y cantidades (MODIFICADA: Antes Detalle de factura)
--------------------------------------------------
SELECT oc.nro_orden, DATE_FORMAT(oc.fecha, '%d/%m/%Y'), CONCAT(
    ...
    ),i.razon_social, p.nombre_pieza, ocd.cantidad
FROM OrdenCompra oc
JOIN Importador i ON oc.id_importador = i.id_importador
JOIN OrdenCompra_Detalle ocd ON oc.id_orden = ocd.id_orden
JOIN Pieza p ON ocd.id_pieza = p.id_pieza
WHERE oc.nro_orden = 00001234;